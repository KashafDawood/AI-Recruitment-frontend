  ...
  return (
    <section className="bg-gray-50 py-16 md:py-20 dark:bg-transparent">
      <div className="flex justify-center flex-col text-center max-w-3xl mx-auto mb-16">
        <motion.section
          className="bg-gray-50 py-16 md:py-20 dark:bg-transparent"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.1 }}
        >
          <motion.div
            className="flex justify-center flex-col text-center max-w-3xl mx-auto mb-16"
          ...
          >
            ...
            <motion.p
              ...
              variants={cardVariants}
            >
              Discover our AI-powered recruitment tools designed to streamline
              your hiring process and connect the right talent with the right
              opportunities.
            </motion.p>
          </motion.div>
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="relative">
          ...
          >
            ...
            >
              <Card className="relative flex overflow-hidden h-full dark:bg-gray-800">
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="relative z-10 mt-6 space-y-2 text-center">
                    ...
                    <p className="text-foreground">
                      ...
                      AI-powered job post generator. Attract the right
            ...
            >
              <Card className="card variant-outlined relative overflow-hidden h-full dark:bg-gray-800">
                <CardContent className="grid pt-6 sm:grid-cols-2">
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-foreground">
                        Our AI matches the perfect candidates to your job
                        postings based on skills, experience, and cultural fit.
                      </p>
                    </div>
                  </div>
            ...
            <motion.div
              variants={cardVariants}
              className="col-span-full sm:col-span-6 lg:col-span-6"
            >
              <Card className="relative overflow-hidden h-full dark:bg-gray-800">
                <CardContent className="grid pt-6 sm:grid-cols-2">
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
