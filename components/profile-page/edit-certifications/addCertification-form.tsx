...
import { addCertificate } from "@/api/user/addCertificate";
...
export default function AddCertificationForm({
  ...
  const [dateObtained, setDateObtained] = useState<Date | undefined>(undefined);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await addCertificate(certificationData);
      await refreshUser();
