...
export default function SavedJobs() {
  ...
  const handleSaveJob = async (jobId: number) => {
    try {
      ...
      //sort the jobs array in descending order
  ...
  return (
    <div>
      ...
      <Dialog>
        <DialogTrigger className="ml-6 text-blue-900 dark:text-blue-500 font-bold">
          Not seeing a Job?
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-bold">Not seeing a job?</DialogTitle>
            <div className="text-sm text-gray-500 dark:text-gray-400 mt-4 border-t pt-8">
